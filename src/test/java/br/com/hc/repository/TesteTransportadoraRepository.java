...
public class TesteTransportadoraRepository {
	...
	public void testeCadastrarTransportadora() {
		...
		transportadora.setTelefone(listaTelefone);
		transportadora.setModal(listaModal);
		...
		transportadora2.setTelefone(listaTelefone2);
		transportadora2.setModal(listaModal2);
	...
	public void testePesquisarTransportadora() {
		...
		filtro.setModal(transCadastrada.getModal().get(0).getModal());
